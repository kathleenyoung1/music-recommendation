...
def main(spark):
    ...
    for k in alphas:
        startnow = time.time()
        als = ALS(maxIter=20, regParam=0.001,rank = 100, alpha = k, userCol="nuser_id", itemCol="ntrack_id", ratingCol="count", coldStartStrategy="drop")
        ...
        # evalute
        print("alpha used: ", k, "rmse: ", rmse, "it took ", endnow - startnow)
